...
export default function HeroSpline() {
  return (
    <section className="relative w-full bg-[#0b1020] overflow-hidden rounded-2xl shadow-xl">
      ...
      />
      <div className="absolute inset-x-0 top-0 p-6 md:p-8 flex flex-col items-center text-center">
        <span className="inline-flex items-center gap-2 text-xs md:text-sm font-medium text-white/80 bg-white/10 backdrop-blur-md rounded-full px-3 py-1 border border-white/10">
